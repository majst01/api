...
var file_api_v1_health_proto_rawDesc = []byte{
	...
	0xf3, 0x18, 0x01, 0xe0, 0xf3, 0x18, 0x02, 0x42, 0x7e, 0x0a, 0x0a, 0x63, 0x6f, 0x6d, 0x2e, 0x61,
...
func file_api_v1_health_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_api_v1_health_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Health); i {
			case 0:
				return &v.state
			case 1:
		...
		file_api_v1_health_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_api_v1_health_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_api_v1_health_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_api_v1_health_proto_msgTypes[4].Exporter = func(v any, i int) any {
