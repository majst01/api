...
func (_m *TokenServiceClient) Get(_a0 context.Context, _a1 *connect.Request[apiv1.TokenServiceGetRequest]) (*connect.Response[apiv1.TokenServiceGetResponse], error) {
	ret := _m.Called(_a0, _a1)
...
func (_m *TokenServiceClient) Update(_a0 context.Context, _a1 *connect.Request[apiv1.TokenServiceUpdateRequest]) (*connect.Response[apiv1.TokenServiceUpdateResponse], error) {
	ret := _m.Called(_a0, _a1)
