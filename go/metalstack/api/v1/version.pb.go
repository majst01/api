...
// 	protoc        (unknown)
// source: metalstack/api/v1/version.proto
...
func (x *Version) Reset() {
	*x = Version{}
	mi := &file_metalstack_api_v1_version_proto_msgTypes[0]
...
func (*Version) Descriptor() ([]byte, []int) {
	return file_metalstack_api_v1_version_proto_rawDescGZIP(), []int{0}
}
...
func (x *VersionServiceGetRequest) Reset() {
	*x = VersionServiceGetRequest{}
	mi := &file_metalstack_api_v1_version_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*VersionServiceGetRequest) Descriptor() ([]byte, []int) {
	return file_metalstack_api_v1_version_proto_rawDescGZIP(), []int{1}
}
...
func (x *VersionServiceGetResponse) Reset() {
	*x = VersionServiceGetResponse{}
	mi := &file_metalstack_api_v1_version_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*VersionServiceGetResponse) Descriptor() ([]byte, []int) {
	return file_metalstack_api_v1_version_proto_rawDescGZIP(), []int{2}
}
...
var File_metalstack_api_v1_version_proto protoreflect.FileDescriptor

var file_metalstack_api_v1_version_proto_rawDesc = string([]byte{
	...
	0x69, 0x2e, 0x76, 0x31, 0x1a, 0x1e, 0x6d, 0x65, 0x74, 0x61, 0x6c, 0x73, 0x74, 0x61, 0x63, 0x6b,
	...
	0x6c, 0x73, 0x74, 0x61, 0x63, 0x6b, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x76, 0x31, 0x2e, 0x56, 0x65,
	...
	0x74, 0x61, 0x63, 0x6b, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x76, 0x31, 0x2e, 0x56, 0x65, 0x72, 0x73,
	...
	0x6b, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x76, 0x31, 0x2e, 0x56, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e,
	...
	0x61, 0x70, 0x69, 0x2e, 0x76, 0x31, 0x42, 0x0c, 0x56, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x50,
...
var (
	file_metalstack_api_v1_version_proto_rawDescOnce sync.Once
	file_metalstack_api_v1_version_proto_rawDescData []byte
)

func file_metalstack_api_v1_version_proto_rawDescGZIP() []byte {
	file_metalstack_api_v1_version_proto_rawDescOnce.Do(func() {
		file_metalstack_api_v1_version_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_metalstack_api_v1_version_proto_rawDesc), len(file_metalstack_api_v1_version_proto_rawDesc)))
	})
	return file_metalstack_api_v1_version_proto_rawDescData
}

var file_metalstack_api_v1_version_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_metalstack_api_v1_version_proto_goTypes = []any{
	(*Version)(nil),                   // 0: metalstack.api.v1.Version
	(*VersionServiceGetRequest)(nil),  // 1: metalstack.api.v1.VersionServiceGetRequest
	(*VersionServiceGetResponse)(nil), // 2: metalstack.api.v1.VersionServiceGetResponse
}
var file_metalstack_api_v1_version_proto_depIdxs = []int32{
	0, // 0: metalstack.api.v1.VersionServiceGetResponse.version:type_name -> metalstack.api.v1.Version
	1, // 1: metalstack.api.v1.VersionService.Get:input_type -> metalstack.api.v1.VersionServiceGetRequest
	2, // 2: metalstack.api.v1.VersionService.Get:output_type -> metalstack.api.v1.VersionServiceGetResponse
...
func init() { file_metalstack_api_v1_version_proto_init() }
func file_metalstack_api_v1_version_proto_init() {
	if File_metalstack_api_v1_version_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_metalstack_api_v1_version_proto_rawDesc), len(file_metalstack_api_v1_version_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_metalstack_api_v1_version_proto_goTypes,
		DependencyIndexes: file_metalstack_api_v1_version_proto_depIdxs,
		MessageInfos:      file_metalstack_api_v1_version_proto_msgTypes,
	}.Build()
	File_metalstack_api_v1_version_proto = out.File
	file_metalstack_api_v1_version_proto_goTypes = nil
	file_metalstack_api_v1_version_proto_depIdxs = nil
}
