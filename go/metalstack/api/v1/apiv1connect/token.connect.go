...
const (
	...
	TokenServiceName = "metalstack.api.v1.TokenService"
)
...
const (
	...
	TokenServiceGetProcedure = "/metalstack.api.v1.TokenService/Get"
	// TokenServiceCreateProcedure is the fully-qualified name of the TokenService's Create RPC.
	TokenServiceCreateProcedure = "/metalstack.api.v1.TokenService/Create"
	// TokenServiceUpdateProcedure is the fully-qualified name of the TokenService's Update RPC.
	TokenServiceUpdateProcedure = "/metalstack.api.v1.TokenService/Update"
	// TokenServiceListProcedure is the fully-qualified name of the TokenService's List RPC.
	TokenServiceListProcedure = "/metalstack.api.v1.TokenService/List"
	// TokenServiceRevokeProcedure is the fully-qualified name of the TokenService's Revoke RPC.
	TokenServiceRevokeProcedure = "/metalstack.api.v1.TokenService/Revoke"
)

// TokenServiceClient is a client for the metalstack.api.v1.TokenService service.
...
// NewTokenServiceClient constructs a client for the metalstack.api.v1.TokenService service. By
...
func NewTokenServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) TokenServiceClient {
	...
	tokenServiceMethods := v1.File_metalstack_api_v1_token_proto.Services().ByName("TokenService").Methods()
...
// Get calls metalstack.api.v1.TokenService.Get.
...
// Create calls metalstack.api.v1.TokenService.Create.
...
// Update calls metalstack.api.v1.TokenService.Update.
...
// List calls metalstack.api.v1.TokenService.List.
...
// Revoke calls metalstack.api.v1.TokenService.Revoke.
...
// TokenServiceHandler is an implementation of the metalstack.api.v1.TokenService service.
...
func NewTokenServiceHandler(svc TokenServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/metalstack.api.v1.TokenService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedTokenServiceHandler) Get(context.Context, *connect.Request[v1.TokenServiceGetRequest]) (*connect.Response[v1.TokenServiceGetResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("metalstack.api.v1.TokenService.Get is not implemented"))
}
...
func (UnimplementedTokenServiceHandler) Create(context.Context, *connect.Request[v1.TokenServiceCreateRequest]) (*connect.Response[v1.TokenServiceCreateResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("metalstack.api.v1.TokenService.Create is not implemented"))
}
...
func (UnimplementedTokenServiceHandler) Update(context.Context, *connect.Request[v1.TokenServiceUpdateRequest]) (*connect.Response[v1.TokenServiceUpdateResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("metalstack.api.v1.TokenService.Update is not implemented"))
}
...
func (UnimplementedTokenServiceHandler) List(context.Context, *connect.Request[v1.TokenServiceListRequest]) (*connect.Response[v1.TokenServiceListResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("metalstack.api.v1.TokenService.List is not implemented"))
}
...
func (UnimplementedTokenServiceHandler) Revoke(context.Context, *connect.Request[v1.TokenServiceRevokeRequest]) (*connect.Response[v1.TokenServiceRevokeResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("metalstack.api.v1.TokenService.Revoke is not implemented"))
}
