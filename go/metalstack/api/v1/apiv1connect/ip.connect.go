...
const (
	...
	IPServiceName = "metalstack.api.v1.IPService"
)
...
const (
	...
	IPServiceGetProcedure = "/metalstack.api.v1.IPService/Get"
	// IPServiceAllocateProcedure is the fully-qualified name of the IPService's Allocate RPC.
	IPServiceAllocateProcedure = "/metalstack.api.v1.IPService/Allocate"
	// IPServiceUpdateProcedure is the fully-qualified name of the IPService's Update RPC.
	IPServiceUpdateProcedure = "/metalstack.api.v1.IPService/Update"
	// IPServiceListProcedure is the fully-qualified name of the IPService's List RPC.
	IPServiceListProcedure = "/metalstack.api.v1.IPService/List"
	// IPServiceDeleteProcedure is the fully-qualified name of the IPService's Delete RPC.
	IPServiceDeleteProcedure = "/metalstack.api.v1.IPService/Delete"
)

// IPServiceClient is a client for the metalstack.api.v1.IPService service.
...
// NewIPServiceClient constructs a client for the metalstack.api.v1.IPService service. By default,
...
func NewIPServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) IPServiceClient {
	...
	iPServiceMethods := v1.File_metalstack_api_v1_ip_proto.Services().ByName("IPService").Methods()
...
// Get calls metalstack.api.v1.IPService.Get.
...
// Allocate calls metalstack.api.v1.IPService.Allocate.
...
// Update calls metalstack.api.v1.IPService.Update.
...
// List calls metalstack.api.v1.IPService.List.
...
// Delete calls metalstack.api.v1.IPService.Delete.
...
// IPServiceHandler is an implementation of the metalstack.api.v1.IPService service.
...
func NewIPServiceHandler(svc IPServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/metalstack.api.v1.IPService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedIPServiceHandler) Get(context.Context, *connect.Request[v1.IPServiceGetRequest]) (*connect.Response[v1.IPServiceGetResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("metalstack.api.v1.IPService.Get is not implemented"))
}
...
func (UnimplementedIPServiceHandler) Allocate(context.Context, *connect.Request[v1.IPServiceAllocateRequest]) (*connect.Response[v1.IPServiceAllocateResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("metalstack.api.v1.IPService.Allocate is not implemented"))
}
...
func (UnimplementedIPServiceHandler) Update(context.Context, *connect.Request[v1.IPServiceUpdateRequest]) (*connect.Response[v1.IPServiceUpdateResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("metalstack.api.v1.IPService.Update is not implemented"))
}
...
func (UnimplementedIPServiceHandler) List(context.Context, *connect.Request[v1.IPServiceListRequest]) (*connect.Response[v1.IPServiceListResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("metalstack.api.v1.IPService.List is not implemented"))
}
...
func (UnimplementedIPServiceHandler) Delete(context.Context, *connect.Request[v1.IPServiceDeleteRequest]) (*connect.Response[v1.IPServiceDeleteResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("metalstack.api.v1.IPService.Delete is not implemented"))
}
