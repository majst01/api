...
const (
	...
	HealthServiceName = "metalstack.api.v1.HealthService"
)
...
const (
	...
	HealthServiceGetProcedure = "/metalstack.api.v1.HealthService/Get"
)

// HealthServiceClient is a client for the metalstack.api.v1.HealthService service.
...
// NewHealthServiceClient constructs a client for the metalstack.api.v1.HealthService service. By
...
func NewHealthServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) HealthServiceClient {
	...
	healthServiceMethods := v1.File_metalstack_api_v1_health_proto.Services().ByName("HealthService").Methods()
...
// Get calls metalstack.api.v1.HealthService.Get.
...
// HealthServiceHandler is an implementation of the metalstack.api.v1.HealthService service.
...
func NewHealthServiceHandler(svc HealthServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/metalstack.api.v1.HealthService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedHealthServiceHandler) Get(context.Context, *connect.Request[v1.HealthServiceGetRequest]) (*connect.Response[v1.HealthServiceGetResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("metalstack.api.v1.HealthService.Get is not implemented"))
}
