...
const (
	...
	VersionServiceName = "metalstack.api.v1.VersionService"
)
...
const (
	...
	VersionServiceGetProcedure = "/metalstack.api.v1.VersionService/Get"
)

// VersionServiceClient is a client for the metalstack.api.v1.VersionService service.
...
// NewVersionServiceClient constructs a client for the metalstack.api.v1.VersionService service. By
...
func NewVersionServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) VersionServiceClient {
	...
	versionServiceMethods := v1.File_metalstack_api_v1_version_proto.Services().ByName("VersionService").Methods()
...
// Get calls metalstack.api.v1.VersionService.Get.
...
// VersionServiceHandler is an implementation of the metalstack.api.v1.VersionService service.
...
func NewVersionServiceHandler(svc VersionServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/metalstack.api.v1.VersionService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedVersionServiceHandler) Get(context.Context, *connect.Request[v1.VersionServiceGetRequest]) (*connect.Response[v1.VersionServiceGetResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("metalstack.api.v1.VersionService.Get is not implemented"))
}
