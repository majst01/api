...
const (
	...
	MethodServiceName = "metalstack.api.v1.MethodService"
)
...
const (
	...
	MethodServiceListProcedure = "/metalstack.api.v1.MethodService/List"
	// MethodServiceTokenScopedListProcedure is the fully-qualified name of the MethodService's
	// TokenScopedList RPC.
	MethodServiceTokenScopedListProcedure = "/metalstack.api.v1.MethodService/TokenScopedList"
)

// MethodServiceClient is a client for the metalstack.api.v1.MethodService service.
...
// NewMethodServiceClient constructs a client for the metalstack.api.v1.MethodService service. By
...
func NewMethodServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) MethodServiceClient {
	...
	methodServiceMethods := v1.File_metalstack_api_v1_methods_proto.Services().ByName("MethodService").Methods()
...
// List calls metalstack.api.v1.MethodService.List.
...
// TokenScopedList calls metalstack.api.v1.MethodService.TokenScopedList.
...
// MethodServiceHandler is an implementation of the metalstack.api.v1.MethodService service.
...
func NewMethodServiceHandler(svc MethodServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/metalstack.api.v1.MethodService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedMethodServiceHandler) List(context.Context, *connect.Request[v1.MethodServiceListRequest]) (*connect.Response[v1.MethodServiceListResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("metalstack.api.v1.MethodService.List is not implemented"))
}
...
func (UnimplementedMethodServiceHandler) TokenScopedList(context.Context, *connect.Request[v1.MethodServiceTokenScopedListRequest]) (*connect.Response[v1.MethodServiceTokenScopedListResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("metalstack.api.v1.MethodService.TokenScopedList is not implemented"))
}
