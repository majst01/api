...
const (
	...
	TokenServiceName = "metalstack.admin.v1.TokenService"
)
...
const (
	...
	TokenServiceListProcedure = "/metalstack.admin.v1.TokenService/List"
	// TokenServiceRevokeProcedure is the fully-qualified name of the TokenService's Revoke RPC.
	TokenServiceRevokeProcedure = "/metalstack.admin.v1.TokenService/Revoke"
)

// TokenServiceClient is a client for the metalstack.admin.v1.TokenService service.
...
// NewTokenServiceClient constructs a client for the metalstack.admin.v1.TokenService service. By
...
func NewTokenServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) TokenServiceClient {
	...
	tokenServiceMethods := v1.File_metalstack_admin_v1_token_proto.Services().ByName("TokenService").Methods()
...
// List calls metalstack.admin.v1.TokenService.List.
...
// Revoke calls metalstack.admin.v1.TokenService.Revoke.
...
// TokenServiceHandler is an implementation of the metalstack.admin.v1.TokenService service.
...
func NewTokenServiceHandler(svc TokenServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/metalstack.admin.v1.TokenService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedTokenServiceHandler) List(context.Context, *connect.Request[v1.TokenServiceListRequest]) (*connect.Response[v1.TokenServiceListResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("metalstack.admin.v1.TokenService.List is not implemented"))
}
...
func (UnimplementedTokenServiceHandler) Revoke(context.Context, *connect.Request[v1.TokenServiceRevokeRequest]) (*connect.Response[v1.TokenServiceRevokeResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("metalstack.admin.v1.TokenService.Revoke is not implemented"))
}
