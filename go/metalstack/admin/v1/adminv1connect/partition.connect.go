...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/metal-stack/api/go/metalstack/admin/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	PartitionServiceName = "metalstack.admin.v1.PartitionService"
)
...
const (
	...
	PartitionServiceCreateProcedure = "/metalstack.admin.v1.PartitionService/Create"
	// PartitionServiceUpdateProcedure is the fully-qualified name of the PartitionService's Update RPC.
	PartitionServiceUpdateProcedure = "/metalstack.admin.v1.PartitionService/Update"
	// PartitionServiceDeleteProcedure is the fully-qualified name of the PartitionService's Delete RPC.
	PartitionServiceDeleteProcedure = "/metalstack.admin.v1.PartitionService/Delete"
)

// PartitionServiceClient is a client for the metalstack.admin.v1.PartitionService service.
...
// NewPartitionServiceClient constructs a client for the metalstack.admin.v1.PartitionService
...
func NewPartitionServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) PartitionServiceClient {
	...
	partitionServiceMethods := v1.File_metalstack_admin_v1_partition_proto.Services().ByName("PartitionService").Methods()
...
// Create calls metalstack.admin.v1.PartitionService.Create.
...
// Update calls metalstack.admin.v1.PartitionService.Update.
...
// Delete calls metalstack.admin.v1.PartitionService.Delete.
...
// PartitionServiceHandler is an implementation of the metalstack.admin.v1.PartitionService service.
...
func NewPartitionServiceHandler(svc PartitionServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/metalstack.admin.v1.PartitionService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedPartitionServiceHandler) Create(context.Context, *connect.Request[v1.PartitionServiceCreateRequest]) (*connect.Response[v1.PartitionServiceCreateResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("metalstack.admin.v1.PartitionService.Create is not implemented"))
}
...
func (UnimplementedPartitionServiceHandler) Update(context.Context, *connect.Request[v1.PartitionServiceUpdateRequest]) (*connect.Response[v1.PartitionServiceUpdateResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("metalstack.admin.v1.PartitionService.Update is not implemented"))
}
...
func (UnimplementedPartitionServiceHandler) Delete(context.Context, *connect.Request[v1.PartitionServiceDeleteRequest]) (*connect.Response[v1.PartitionServiceDeleteResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("metalstack.admin.v1.PartitionService.Delete is not implemented"))
}
