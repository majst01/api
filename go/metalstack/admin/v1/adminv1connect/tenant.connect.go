...
const (
	...
	TenantServiceName = "metalstack.admin.v1.TenantService"
)
...
const (
	...
	TenantServiceListProcedure = "/metalstack.admin.v1.TenantService/List"
)

// TenantServiceClient is a client for the metalstack.admin.v1.TenantService service.
...
// NewTenantServiceClient constructs a client for the metalstack.admin.v1.TenantService service. By
...
func NewTenantServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) TenantServiceClient {
	...
	tenantServiceMethods := v1.File_metalstack_admin_v1_tenant_proto.Services().ByName("TenantService").Methods()
...
// List calls metalstack.admin.v1.TenantService.List.
...
// TenantServiceHandler is an implementation of the metalstack.admin.v1.TenantService service.
...
func NewTenantServiceHandler(svc TenantServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/metalstack.admin.v1.TenantService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedTenantServiceHandler) List(context.Context, *connect.Request[v1.TenantServiceListRequest]) (*connect.Response[v1.TenantServiceListResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("metalstack.admin.v1.TenantService.List is not implemented"))
}
